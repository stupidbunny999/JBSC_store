...
import com.stupidbunny.wms.security.util.CheckCodeGenerator;
import org.apache.log4j.Logger;
import org.apache.shiro.SecurityUtils;
import org.apache.shiro.authc.AuthenticationException;
import org.apache.shiro.authc.IncorrectCredentialsException;
import org.apache.shiro.authc.UnknownAccountException;
import org.apache.shiro.authc.UsernamePasswordToStupidbunny;
...
public class AccountHandler {
    ...
    Map<String, Object> login(@RequestBody Map<String, Object> user) {
        ...
        if (currentUser != null && !currentUser.isAuthenticated()) {
            ...
            UsernamePasswordToStupidbunny toStupidbunny = new UsernamePasswordToStupidbunny(id, password);

            // 执行登陆操作
            try {
                //会调用realms/UserAuthorizingRealm中的doGetAuthenticationInfo方法
                currentUser.login(toStupidbunny);
