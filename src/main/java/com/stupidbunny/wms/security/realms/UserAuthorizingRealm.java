package com.stupidbunny.wms.security.realms;

import com.stupidbunny.wms.common.service.Interface.RepositoryAdminManageService;
import com.stupidbunny.wms.common.service.Interface.SystemLogService;
import com.stupidbunny.wms.domain.RepositoryAdmin;
import com.stupidbunny.wms.domain.UserInfoDTO;
import com.stupidbunny.wms.exception.RepositoryAdminManageServiceException;
...
public class UserAuthorizingRealm extends AuthorizingRealm {
     ...
     * 对用户进行认证
     *
     * @param authenticationToStupidbunny 用户凭证
     * @return 返回用户的认证信息
     * @throws AuthenticationException 用户认证异常信息
     * Realm的认证方法，自动将toStupidbunny传入，比较toStupidbunny与数据库的数据是否匹配
     * 验证逻辑是先根据用户名查询用户，
    ...
    @SuppressWarnings("unchecked")
    @Override
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToStupidbunny authenticationToStupidbunny) throws
        ...
        // 获取用户名对应的用户账户信息
        try {
            UsernamePasswordToStupidbunny usernamePasswordToStupidbunny = (UsernamePasswordToStupidbunny) authenticationToStupidbunny;
            String principal = usernamePasswordToStupidbunny.getUsername();
            ...
            //realmName为com.Stupidbunny.wms.security.realms.UserAuthorizingRealm_0
